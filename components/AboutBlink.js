...
import styles from './AboutBlink.style';

export default function AboutBlink({navigation}) {
  return (
    <SafeAreaView>
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        <SettingItem 
        IconComponent={Icon} 
        icon="settings" label="Advanced Options" NextScreen="AdvanceOptions" navigation={navigation} />
      </View>
