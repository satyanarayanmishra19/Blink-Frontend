...
const ProfileComponent = ({ navigation, route }) => {
  ...
  const updateUserNumber = async () => {
    ...
    try {
      ...
      const response = await fetch('http://192.168.65.102:8080/api/users/update-number', {
        method: 'PUT',
        headers: {
  ...
  const updateUserEmail = async () => {
    try {
      ...
      const response = await fetch('http://192.168.65.102:8080/api/users/update-email', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const updateUserName = async () => {
    try {
      ...
      const response = await fetch('http://192.168.65.102:8080/api/users/update-name', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const verifyEmailOtp = async () => {
    try {
      ...
      const response = await fetch('http://192.168.65.102:8080/api/users/verify-email-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const verifyPhoneOtp = async () => {
    try {
      ...
      const response = await fetch('http://192.168.65.102:8080/api/users/verify-phone-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
